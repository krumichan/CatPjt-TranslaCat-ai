...
PROMPT_MAP = {
    ...
    "CHAT_MESSAGE_TRANSLATION": """
        ...
        # Task
        Translate the user's chat message into the target language specified in the input JSON.

        # Input JSON
        The input will be a JSON object with:
        - text: original chat message
        - target_language_code: target language code, such as ko, ja, en
        ...
        # Style
        - For Korean, use natural casual/polite chat style depending on the original tone.
        - For Japanese, use natural chat Japanese and preserve politeness level when possible.
